...
`;
    ...
    return (
      <div id="plugin_embeddable-billing-settings" className="plugin_container">
        <div
          id="_section-1"
          className={`_section ${selectedServer && "_active"}`}
        >
          ...
          <div className="_indented">
            <p className="form-help-text">
              {" "}
              In order to embed the management so users can add cards, cancel,
              and resubscribe you need to generate a token which will
              authenticate your users and be used by the client-side javascript.
            </p>
            <div className="sb-form-group">
              <select
                className="_input- _input-select-a-framework"
        ...
        >
          ...
          <div className="_indented">
            <p className="form-help-text">
              <strong>DO NOT EXPOSE THE SECRET KEY TO THE PUBLIC</strong>, make
              sure not to commit it into version control or send under insecure
              channels or expose to client
            </p>
            <SyntaxHighlighter
              showLineNumbers
              language={selectedLang(selectedServer)}
              style={duotoneDark}
            >
              {server}
            </SyntaxHighlighter>
        ...
        >
          ...
          <div className="_indented">
            <p className="form-help-text">
              ...
              client...(with the proper token) for technical documentation,
              <a href="https://docs.servicebot.io/billing-settings-embed">
                see here
              </a>
            </p>
            <SyntaxHighlighter
