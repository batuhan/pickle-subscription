...
function* run(config, provide, channels) {
    ...
    const messageManager = {
        async send(to_id, from_id, service_instance_id=0, message, subject="New message on your service"){
            ...
            const newMessage = await Messages.createPromise({"user_id" : from_id, service_instance_id, message})
