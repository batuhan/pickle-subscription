const {call, take, takeEvery, cancel, actionChannel} = require("redux-saga/effects");
...
module.exports = {
    *run(config, provide, services){
        try {
            ...
            const {initialConfig, response} = yield call(app, config.appConfig, config.initialConfig || {}, setup.dbConfig, expressApp);
