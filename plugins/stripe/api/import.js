...
module.exports = function(knex) {
          ...
          if (!err) {
            Promise.all(
              plans.data.map(function(plan) {
                return importServiceTemplate(category, plan).catch(function(
                  err,
                ) {
                  console.log(err);
                  return Promise.resolve(true);
  ...
  const importStripeSubscriptions = function(last_id) {
    ...
    return new Promise(function(resolve, reject) {
      stripe().connection.subscriptions.list(req_params, function(
        err,
        subscriptions,
      ) {
        if (!err) {
    ...
    return new Promise(function(resolve, reject) {
      ...
      return new Promise(function(resolve, reject) {
        if (!template) {
          ...
          const template = new ServiceTemplate(newPlan);
  ...
  let importServiceInstance = function(subscription) {
    return new Promise(function(resolve, reject) {
      ...
      .then(function(service) {
        return new Promise(function(resolve, reject) {
          ServiceTemplate.findOne("name", service.payment_plan.id, function(
            template,
          ) {
            if (template.data) {
