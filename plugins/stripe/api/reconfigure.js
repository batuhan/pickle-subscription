   ...
   const getStripeKeys = function (req, res) {
        SystemOptions.findOne('option', 'stripe_secret_key', function (option_secret_key) {
            SystemOptions.findOne('option', 'stripe_publishable_key', function (option_publishable_key) {
                ...
                const secret_key = `${option_secret_key.data.value.substring(0,7)  }******${  option_secret_key.data.value.substring(option_secret_key.data.value.length-5,option_secret_key.data.value.length)}`;
