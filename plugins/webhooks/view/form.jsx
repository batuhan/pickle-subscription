    ...
    return (
      <div>
        ...
        >
          <h3>Embed</h3>
          <span>
            Servicebot has embeddable forms which can facilitate actions such as
            subscribing, adding a credit card, cancelling, and resubscribing
          </span>
          {this.state.showFormEmbed ? (
            <div className="sbi--modal">
              {formEmbed}
              <button
                className="sbi--embed-code-button sbi--ecb--hide"
            ...
            <div className="sbi--embed-button-wrapper">
              <span className="sbi--embed-label">
                Embed to allow customers to request new subscriptions
              </span>
              <button
                className="sbi--embed-code-button"
          ...
          {this.state.showManagementEmbed ? (
            ...
            <div className="sbi--embed-button-wrapper">
              <span className="sbi--embed-label">
                Embed to allow customers to manage thier account and billing
                settings
              </span>
              <button
                className="sbi--embed-code-button"
                onClick={this.showManagement}
              >
                Get Embed Code
              </button>
            </div>
          ...
          <h3>Webhooks</h3>
          <span>
            Servicebot can send webhook events that notify your application any
            time an event happens. This is especially useful for events—like new
            customer subscription or trial expiration—that your SaaS product
            needs to know about. You can integrate your SaaS with Servicebot by
            listening to API calls sent from your Servicebot instance to your
            SaaS product.
          </span>

          <div className="sbi--webhook-button-wrapper">
            <span className="sbi--webhook-label">
              Add and test your webhooks
            </span>
            <button
              className="sbi--webhook-button"
              onClick={() => {
                self.openHookForm({});
              }}
              type="submit"
          ...
          <div className="service-instance-box navy webhook-info">
            <div className="service-instance-box-title">
              ...
              <div className="pull-right">
                {!this.state.showEventsInfo ? (
                  <button
                    className="btn btn-default btn-rounded btn-sm m-r-5 application-launcher"
            ...
            {this.state.showEventsInfo && (
              <div className="service-instance-box-content">
                <p>
                  The webhook system can notify your SaaS application if any of
                  the following events occour:
                </p>
                <a href="https://docs.servicebot.io/webhooks/" target="_BLANK">
          ...
          <div className="form-row">
            {hooks.map((hook, index) => {
              ...
              if (!hook.health) {
                health = (
                  <span className="status-badge neutral">Test Endpoints</span>
                );
              ...
              if (hook.async_lifecycle === false) {
                type = (
                  <span className="status-badge purple m-r-5">Synchronous</span>
                );
              }
              return (
