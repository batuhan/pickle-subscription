!(function() {
  ...
  (n.prototype = {
    ...
    setOption(t, e) {
      if (t !== "show_errors")
        throw `Option ${t} must be set during instantiation and cannot be changed later`;
            ...
            if (this.schema.watch.hasOwnProperty(o)) {
              if (
                ...
                Array.isArray(e)
                  ...
                  : ((i = e.split(".")),
                    t.theme.closest(t.container, `[data-schemaid="${i[0]}"]`) ||
                      i.unshift("#")),
                (s = i.shift()),
      ...
      getHTML(t) {
        ...
        if (typeof t === "object") {
          ...
          return (
            s(t, function(s, r) {
              let n = e.getHTML(r);
              Array.isArray(t) || (n = `<div><em>${s}</em>: ${n}</div>`),
                (i += `<li>${n}</li>`);
            }),
            (i = Array.isArray(t)
              ? `<ol>${i}</ol>`
    ...
    (n.defaults.editors.base64 = n.AbstractEditor.extend({
      ...
      refreshPreview() {
        if (
          ...
          if ((t && (t = t[1]), t)) {
            if (
              ((this.preview.innerHTML = `<strong>Type:</strong> ${t}, <strong>Size:</strong> ${Math.floor(
