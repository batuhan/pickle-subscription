...
!(function(a, b) {
  ...
  (n.filter = function(a, b, c) {
    ...
    n.fn.extend({
      ...
      is(a) {
        return !!z(this, typeof a === "string" && w.test(a) ? n(a) : a || [], !1)
          .length;
      },
    });
  let A;
  ...
  function W(a, b, c, d) {
    let e;
      ...
      let k = (n.cssNumber[b] || (j !== "px" && +i)) && T.exec(n.css(a, b));
    if (k && k[3] !== j) {
      (j = j || k[3]), (c = c || []), (k = +i || 1);
  ...
  const da = /^key/;
    const ea = /^(?:mouse|pointer|contextmenu|drag|drop)|click/;
    const fa = /^([^.]*)(?:\.(.+)|)/;
  function ga() {
    return !0;
  }
  ...
  function sa(a, b) {
    let c; let d; let e; let f; let g; let h; let i; let j;
    if (b.nodeType === 1) {
      if (
        N.hasData(a) &&
