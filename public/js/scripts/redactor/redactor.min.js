!(function(t) {
  ...
  (t.fn.redactor = function(i) {
    ...
    return (
      "string" == typeof i
        ? this.each(function() {
            var e,
              s = t.data(this, "redactor");
            if (
              ("-1" !== i.search(/\./)
                ? ((e = i.split(".")),
                  "undefined" != typeof s[e[0]] && (e = s[e[0]][e[1]]))
                : (e = s[i]),
              "undefined" != typeof s && t.isFunction(e))
            ) {
              var n = e.apply(s, r);
    ...
    (e.fn = t.Redactor.prototype = {
          ...
          !this.$element.hasClass("redactor-click-to-edit")
            ...
            : (this.$element.hasClass("redactor-click-to-edit") &&
              ...
              (this.opts.dragImageUpload =
                null === this.opts.imageUpload
                  ? !1
                  : this.opts.dragImageUpload),
              (this.opts.dragFileUpload =
                null === this.opts.fileUpload ? !1 : this.opts.dragFileUpload),
              (this.formatting = {}),
              this.lang.load(),
      ...
      loadOptions: function(e) {
        var i = {};
        "undefined" != typeof t.Redactor.settings.namespace
      ...
      bindModuleMethods: function(t) {
        if ("undefined" != typeof this[t]) {
          this[t] = this[t]();
          for (
            var e = this.getModuleMethods(this[t]), i = e.length, o = 0;
            i > o;
            o++
          )
              ...
              .on(
                ...
                t.proxy(function(e) {
                  ...
                  if (
                    ...
                    0 === t(e.target).closest("#redactor-modal").length
                  ) {
        ...
        return {
          ...
          getHiddenFields: function(e) {
            return this.opts.autosaveFields === !1 ||
              "object" != typeof this.opts.autosaveFields
              ? e
              : (t.each(
          ...
          success: function(t) {
            ...
            var o =
              "undefined" == typeof e.error ? "autosave" : "autosaveError";
        ...
        return {
          format: function(e, i, o, r) {
            return (
              ...
              -1 !== t.inArray(e, this.block.tags)
                ? ("p" === e && "undefined" == typeof i && (i = "class"),
          ...
          formatCollapsed: function(e, i, o, r) {
            ...
            return (
              "pre" === e && 1 === a.length && t(a).html(t.trim(t(a).html())),
              this.selection.restore(),
      ...
      buffer: function() {
        return {
          set: function(t) {
            "undefined" == typeof t && this.buffer.clear(),
              "undefined" == typeof t || "undo" === t
                ? this.buffer.setUndo()
                : this.buffer.setRedo();
          },
          setUndo: function() {
        ...
        return {
          ...
          setId: function() {
            ...
            this.core
              ...
              .attr(
                "id",
                "undefined" == typeof t ? "redactor-uuid-" + this.uuid : t,
              );
          },
          getName: function() {
          ...
          setOptions: function() {
            "inline" === this.opts.type && (this.opts.enterKey = !1),
              ("inline" !== this.opts.type && "pre" !== this.opts.type) ||
              ...
              t.each(
                ...
                t.proxy(function(i, o) {
                  var r =
                    ...
                    "undefined" != typeof RedactorPlugins[o]
                      ? RedactorPlugins
                      : e.fn;
                  if (t.isFunction(r[o])) {
                    this[o] = r[o]();
                    for (
                      var s = this.getModuleMethods(this[o]),
                        n = s.length,
                        a = 0;
                      n > a;
                      a++
                    ...
                    if ("undefined" != typeof this[o].langs) {
                      var l = {};
                      "undefined" != typeof this[o].langs[this.opts.lang]
                        ? (l = this[o].langs[this.opts.lang])
                        : "undefined" == typeof this[o].langs[this.opts.lang] &&
                          "undefined" != typeof this[o].langs.en &&
                          (l = this[o].langs.en);
                      var c = this;
                      t.each(l, function(t, e) {
                        "undefined" == typeof c.opts.curLang[t] &&
                          (c.opts.curLang[t] = e);
                      });
                    }
      ...
      button: function() {
        return {
          toolbar: function() {
            return "undefined" != typeof this.button.$toolbar &&
              this.button.$toolbar
              ? this.button.$toolbar
              : this.$toolbar;
          },
          ...
          setFormatting: function() {
            t.each(
              ...
              t.proxy(function(e, i) {
                -1 === t.inArray(e, this.opts.formatting) &&
          ...
          hideButtonsSlicer: function(e) {
            t.each(
              ...
              t.proxy(function(t, e) {
                ...
                -1 !== i && this.opts.buttons.splice(i, 1);
              }, this),
            );
          },
          load: function(e) {
          ...
          toggle: function(t, e, i, o, r) {
            (!this.detect.isIe() && this.detect.isDesktop()) ||
              ...
              "dropdown" !== i && this.dropdown.hideAll(!1),
              this.opts.air && "dropdown" !== i && this.air.hide(t),
              (!this.detect.isIe() && this.detect.isDesktop()) ||
          ...
          add: function(e, i) {
            ...
            var o = this.button.build(e, { title: i });
          ...
          addAfter: function(e, i, o) {
            ...
            var r = this.button.build(i, { title: o }),
              s = this.button.get(e);
            return (
              0 !== s.length
          ...
          setInactiveAll: function(t) {
            ...
            "undefined" != typeof t && (e = e.not(".re-" + t)),
          ...
          after: function(e) {
            ...
            if ((e = this.caret.prepare(e))) {
              ...
              if (this.utils.isBlockTag(e.tagName)) {
                ...
                return void ("undefined" == typeof r
                  ? this.caret.end(e)
                  : ("TABLE" === r.tagName
                      ? (r = t(r)
                          .find("th, td")
        ...
        return {
          ...
          getCurrentType: function(t, e) {
            ...
            return (
              ...
              this.utils.isCurrentOrParent([
                ...
                : 1 === i.length && this.utils.isCurrentOrParent(["li"])
                ? ((o.lists = !0),
                  (o.block = !1),
                  (o.paragraphize = !1),
                  (o.images = !1))
                ...
                : ("pre" === this.opts.type ||
                    (1 === i.length && this.utils.isCurrentOrParent("pre"))) &&
                  ((o.inline = !1),
                  (o.block = !1),
                  (o.encode = !0),
                  (o.pre = !0),
          ...
          convertTags: function(e, i) {
            ...
            if (
              ...
              return e;
            var s,
              n = i.lists ? ["ul", "ol", "li"] : this.opts.pasteBlockTags;
            s =
              i.block || i.lists
                ? i.inline
          ...
          reconvertTags: function(t, e) {
            if (
              ...
              return t;
            var i,
              o = e.lists ? ["ul", "ol", "li"] : this.opts.pasteBlockTags;
            i =
              e.block || e.lists
                ? e.inline
            ...
            (e = t.trim(e)),
              ...
              "textarea" === this.opts.type
                ...
                : "div" === this.opts.type &&
                  ...
                  (e = this.opts.emptyHtml),
              this.core.editor().html(e),
              "textarea" === this.opts.type && this.code.sync(),
      ...
      dropdown: function() {
        return {
          ...
          buildFormatting: function(e, i) {
            return "format" !== e || this.opts.formattingAdd === !1
              ? i
              : (t.each(
                  this.opts.formattingAdd,
                  t.proxy(function(t, e) {
                    var o = this.utils.isBlockTag(e.args[0])
                      ? "block"
                      : "inline";
                    i[t] = {
          ...
          buildItem: function(e, i) {
            var o = t("<li />");
            if (
              ("undefined" != typeof i.classname && o.addClass(i.classname),
              -1 !== e.search(/^divider/i))
            )
          ...
          hideAll: function(e, i) {
            if (
              ...
              e === !1 ||
                0 === t(e.target).closest(".redactor-dropdown").length)
            ) {
              var o =
                  "undefined" == typeof i
      ...
      events: function() {
        return {
          ...
          iterateObserver: function(t) {
            var e = !1;
            ((("textarea" === this.opts.type || "div" === this.opts.type) &&
              !this.detect.isFirefox() &&
          ...
          onDropUpload: function(t) {
            if (
              ...
              (this.opts.dragImageUpload || this.opts.dragFileUpload) &&
                (null !== this.opts.imageUpload ||
                  null !== this.opts.fileUpload))
            ) {
              "IMG" === t.target.tagName && (this.events.dropImage = t.target);
              for (
                var e = t.dataTransfer.files, i = e.length, o = 0;
                i > o;
                o++
              )
          ...
          isCallback: function(e) {
            return (
              "undefined" != typeof this.opts.callbacks[e] &&
        ...
        return {
          ...
          hideResize: function(e) {
            if (
              ...
              0 !== i.length &&
                ...
                "undefined" != typeof this.image.resizeHandle &&
          ...
          showEdit: function(e) {
            if (!this.events.imageEditing) {
              ...
              if (this.opts.imagePosition) {
                var a =
                    0 !== o.length
                      ? "center" === r.css("text-align")
                      : "block" == r.css("display") && "none" == r.css("float"),
          ...
          addCaption: function(e, i) {
            var o = t("#redactor-image-caption").val(),
              r = 0 !== i.length ? i : e,
              s = r.next();
            (0 !== s.length && "FIGCAPTION" === s[0].tagName) || (s = !1),
              "" !== o
                ? s === !1
          ...
          remove: function(e, i, o) {
            (i = "undefined" == typeof i ? t(this.observe.image) : i),
              "boolean" != typeof e && this.buffer.set(),
              this.events.stopDetectChanges();
            ...
            0 !== s.length
              ...
              e !== !1 &&
                (l && 0 !== l.length
                  ? this.caret.start(l)
                  : c && 0 !== c.length && this.caret.end(c)),
              "boolean" != typeof e && this.modal.close(),
        ...
        return {
          ...
          decrease: function() {
            if (this.list.get()) {
              ...
              var i = t(this.selection.current()).closest(
                "li",
                this.core.editor()[0],
              );
              if (
      ...
      insert: function() {
        return {
              ...
              if (this.utils.isSelectAll())
                ...
                if (l === !1) this.insert.placeHtml(e);
                  ...
                  c.append(this.marker.get()),
                    "start" === l.type ? l.$block.before(e) : l.$block.after(e),
                    this.selection.restore(),
                    this.core
                      .editor()
                      .find("p")
          ...
          node: function(e, i) {
            this.placeholder.hide(),
              "undefined" != typeof this.start && this.core.editor().focus(),
              (e = e[0] || e);
            var o = this.selection.block(),
            ...
            if (this.utils.isSelectAll())
              ...
              n === !1
                ...
                : ("start" === n.type ? n.$block.before(e) : n.$block.after(e),
                  this.core
                    .editor()
                    .find("p:empty")
                    .remove());
        ...
        return {
          init: function(e) {
            if (!this.rtePaste) {
              ...
              if (
                ...
                ("textarea" === this.opts.type || "div" === this.opts.type) &&
                  this.keydown.current &&
                  3 === this.keydown.current.nodeType &&
              ...
              if (i === this.keyCode.BACKSPACE || i === this.keyCode.DELETE) {
                if (
                  this.observe.image &&
                  "undefined" != typeof this.observe.image
                ) {
                  e.preventDefault();
              ...
              if (i === this.keyCode.DELETE) {
                ...
                if (
                  ...
                  return l.remove(), !1;
                var c =
                  this.keydown.block && "LI" === this.keydown.block.tagName
                    ? this.keydown.block
                    : !1;
                if (c) {
                  var d = t(this.keydown.block)
                      .parents("ul, ol")
                      .last(),
                    h = d.next();
                  if (
          ...
          exitFromBlockquote: function(e) {
            if (this.utils.isEndOfElement(this.keydown.blockquote)) {
              var i = this.clean.removeSpacesHard(
                t(this.keydown.blockquote).html(),
              );
              if (-1 !== i.search(/(<br\s?\/?>){3}$/i)) {
                e.preventDefault();
                var o = t(this.keydown.blockquote)
                  .children()
                  .last()
                  .prev();
                o
          ...
          onTab: function(t, e) {
            ...
            var o,
              r = i && this.utils.isStartOfElement(this.keydown.block);
            return (
          ...
          wrapToParagraph: function() {
            ...
            e.replaceWith(i);
            var o = t(i).next();
            "undefined" != typeof o[0] && "BR" === o[0].tagName && o.remove(),
              this.caret.end(i);
          },
          ...
          init: function(e) {
            if (!this.rtePaste) {
              ...
              if (
                i === this.keyCode.ENTER &&
                this.keyup.block &&
                "FIGURE" === this.keyup.block.tagName
              ) {
              ...
              if (i === this.keyCode.BACKSPACE || i === this.keyCode.DELETE) {
                ...
                this.keyup.block &&
                  "FIGURE" === this.keyup.block.tagName &&
                  0 === t(this.keyup.block).find("img").length &&
                  (this.selection.save(),
                  this.utils.replaceToTag(this.keyup.block, "p"),
                  this.selection.restore());
              }
      ...
      lang: function() {
        return {
          ...
          get: function(t) {
            return "undefined" != typeof this.opts.curLang[t]
              ? this.opts.curLang[t]
              : "";
          },
        };
      ...
      link: function() {
        return {
          ...
          is: function() {
            var e = this.selection.nodes(),
              i = t(this.selection.current()).closest(
                "a",
                this.core.editor()[0],
              );
          ...
          unlink: function(t) {
            "undefined" != typeof t && t.preventDefault && t.preventDefault(),
              this.buffer.set();
          ...
          isMailto: function(t) {
            return (
              -1 !== t.search("@") && /(http|ftp|https):\/\//i.test(t) === !1
            );
          },
          isEmpty: function(t) {
          ...
          parse: function(t) {
            return (
              this.link.isMailto(t.url)
                ...
                : 0 !== t.url.search("#") && (t.url = this.link.isUrl(t.url)),
          ...
          buildLinkFromObject: function(t, e) {
            return (
              ...
              (e.text =
                "undefined" == typeof e.text && this.selection.is()
                  ? this.selection.text()
          ...
          buildTarget: function(t) {
            return (
              "undefined" != typeof t.attr("target") &&
          ...
          replaceLinksToText: function(e) {
            var i,
              o = t.each(e, function(e, o) {
                var r = t(o),
                  s = t('<span class="redactor-unlink" />').append(
                    r.contents(),
                  );
      ...
      linkify: function() {
        return {
          ...
          breakBlockTag: function(e, i) {
            ...
            if (o !== !1) {
              var r = e;
              "image" === i && (r = t("<figure />").append(e)),
                "start" === o.type ? o.$block.before(r) : o.$block.after(r),
                "image" === i && this.caret.after(r);
            }
          },
          ...
          convertLinks: function(e) {
            ...
            for (var o = i.length, r = 0; o > r; r++) {
              ...
              n.length > this.opts.linkSize &&
                ...
                -1 === n.search("%") && (n = decodeURIComponent(n));
              var l = "\\b";
              -1 !== t.inArray(s.slice(-1), ["/", "&", "="]) && (l = "");
              var c = new RegExp(
                "(" +
                  s.replace(/[\-\[\]\/\{\}\(\)\*\+\?\.\\\^\$\|]/g, "\\$&") +
                  l +
        ...
        return {
          toggle: function(e) {
            if (!this.utils.inBlocks(["table", "td", "th", "tr"])) {
              ...
              var o = t(this.selection.current())
      ...
      modal: function() {
        return {
          ...
          load: function(t, e, i) {
            ("undefined" != typeof this.$modalBox &&
              ...
              "undefined" != typeof this.modal.callbacks[t] &&
          ...
          setDraggable: function() {
            "undefined" != typeof t.fn.draggable &&
          ...
          close: function(e) {
            if (e) {
              if (
                "redactor-modal-button-cancel" !== t(e.target).attr("id") &&
      ...
      observe: function() {
        return {
          load: function() {
            "undefined" == typeof this.opts.destroyed &&
              (this.observe.links(), this.observe.images());
          },
          isCurrent: function(e, i) {
            return (
              "undefined" == typeof i && (i = t(this.selection.current())),
          ...
          buttons: function(e, i) {
            ...
            return (
              ...
              e === !1 && "html" !== i
                ? void (
                    -1 !== t.inArray(i, this.opts.activeButtons) &&
                ...
                : void (
                    ...
                    t.each(
                      ...
                      t.proxy(function(e, i) {
                        ...
                        (0 === s.length || this.utils.isRedactorParent(s)) &&
          ...
          dropdowns: function() {
            ...
            t.each(
              ...
              t.proxy(function(t, r) {
                ...
                (i.closest(n).length > 0 && o) || ("a" === n && 0 !== e)
          ...
          showTooltip: function(e) {
            ...
            if (
              "IMG" !== i[0].tagName &&
              ("A" !== i[0].tagName && (i = i.closest("a", this.$editor[0])),
              "A" === i[0].tagName)
            ) {
              var o = i,
              ...
              var a = t('<a href="' + o.attr("href") + '" target="_blank" />')
                  .html(n)
          ...
          closeTooltip: function(e) {
            ...
            (0 !== o.length && "A" === o[0].tagName && "A" !== i.tagName) ||
              ("A" === i.tagName && this.utils.isRedactorParent(i)) ||
          ...
          restoreSafes: function(e) {
            return (
              t.each(this.paragraphize.safes, function(t, i) {
                (i = "undefined" != typeof i ? i.replace(/\$/g, "&#36;") : i),
      ...
      paste: function() {
        return {
          init: function(e) {
            this.rtePaste = !0;
            var i = !(
              "pre" !== this.opts.type && !this.utils.isCurrentOrParent("pre")
            );
      ...
      placeholder: function() {
        return {
          ...
          isAttr: function() {
            return (
              "undefined" != typeof this.core.element().attr("placeholder") &&
      ...
      selection: function() {
        return {
          ...
          range: function(t) {
            return (
              "undefined" == typeof t && (t = this.selection.get()),
          ...
          isRedactor: function() {
            ...
            if (null !== e) {
              ...
              if (
                t(i).hasClass("redactor-in") ||
                0 !== t(i).parents(".redactor-in").length
              )
                return !0;
            }
            return !1;
              ...
              if (
                ...
                for (var a, l = [i], c = !1, d = !1; !d && (a = l.pop()); )
                  if (3 == a.nodeType) {
                    ...
                    for (var u = a.childNodes.length; u--; )
          ...
          handler: function(e, i, o) {
            ...
            t.each(["alt", "ctrl", "meta", "shift"], function(t, i) {
              ...
              s &&
                ...
                "shift+" === n && (a[this.shortcuts.hotkeysShiftNums[s]] = !0));
        ...
        return {
          ...
          setFixed: function() {
            if (this.opts.toolbarFixed && !this.opts.toolbarExternal) {
              ...
              var i =
                0 !== this.core.box().closest(".modal-body").length ? 1e3 : 0;
              setTimeout(
                t.proxy(function() {
          ...
          observeScrollEnable: function(e, i) {
            if (
              "undefined" != typeof this.fullscreen &&
          ...
          setDropdownPosition: function(e) {
            ...
            t(".redactor-dropdown-" + this.uuid).each(function() {
              var o = t(this),
                ...
                s =
                  "fixed" === e ? i.opts.toolbarFixedTopOffset : r.offset().top;
      ...
      upload: function() {
        return {
          ...
          getType: function(t) {
            (this.upload.type =
              -1 === this.opts.imageTypes.indexOf(t.type) ? "file" : "image"),
              null === this.opts.imageUpload &&
                null !== this.opts.fileUpload &&
                (this.upload.type = "file");
          },
          getHiddenFields: function(e, i) {
            return e === !1 || "object" != typeof e
              ? i
              : (t.each(
                  e,
      ...
      utils: function() {
        return {
          isEmpty: function(e) {
            return (
              (e = "undefined" == typeof e ? this.core.editor().html() : e),
              (e = e.replace(/[\u200B-\u200D\uFEFF]/g, "")),
              (e = e.replace(/&nbsp;/gi, "")),
              (e = e.replace(/<\/?br\s?\/?>/g, "")),
              (e = e.replace(/\s/g, "")),
          ...
          isRedactorParent: function(e) {
            return e
              ? 0 === t(e).parents(".redactor-in").length ||
          ...
          unfreezeScroll: function() {
            "undefined" != typeof this.freezeScrollTop &&
              this.utils.getScrollTarget().scrollTop(this.freezeScrollTop);
          },
          saveScroll: function() {
          ...
          restoreScroll: function() {
            "undefined" != typeof this.tmpScrollTop &&
              this.utils.getScrollTarget().scrollTop(this.tmpScrollTop);
          },
          isStartOfElement: function(t) {
            return "undefined" != typeof t || (t = this.selection.block())
              ? 0 === this.offset.get(t)
              : !1;
          },
          ...
          removeEmptyAttr: function(e, i) {
            var o = t(e);
            return "undefined" == typeof o.attr(i)
              ? !0
              : "" === o.attr(i)
              ? (o.removeAttr(i), !0)
              : !1;
  ...
  (function(t) {
    function e(e, i, o, r) {
      ...
      (this.animation = i),
        (this.slide =
          "slideDown" === this.animation || "slideUp" === this.animation),
        (this.$element = t(e)),
