    ...
    (e.fn = t.Redactor.prototype = {
            ...
            (this.$editor = t("<div />")),
              ...
              this.$box.prepend(
                `<span class="redactor-voice-label" id="redactor-voice-${
                  this.uuid
                }" aria-hidden="false">${this.lang.get(
                  ...
                  if (t.isFunction(r[o])) {
                    ...
                    if (typeof this[o].langs !== "undefined") {
                      ...
                      typeof this[o].langs[this.opts.lang] !== "undefined"
                        ...
                        : typeof this[o].langs[this.opts.lang] ===
                            "undefined" &&
        ...
        return {
          ...
          build(e, i) {
            if (this.opts.toolbar !== !1) {
              ...
              const r = t(
                `<a href="javascript:void(null);" alt="${o}" rel="${e}" />`,
              );
              if (
              ...
              if (
                ...
                const n = t(
                  `<ul class="redactor-dropdown redactor-dropdown-${this.uuid} redactor-dropdown-box-${e}" style="display: none;">`,
                );
          ...
          addDropdown(e, i) {
            if (this.opts.toolbar !== !1) {
              ...
              const r = t(
                `<div class="redactor-dropdown redactor-dropdown-${this.uuid} redactor-dropdown-box-${o}" style="display: none;">`,
              );
              return (
        ...
        return {
              ...
              i.find("p[style]").each(function() {
                ...
                if (e) {
                  ...
                  if (
                    ...
                    if (a > r) {
                      for (
                        var h = i.find(`[data-level="${r}"][data-list="${o}"]`),
                          u = h,
                          p = r;
                        a > p;
                        p++
          ...
          convertTags(e, i) {
            ...
            for (let a = s.length, l = 0; a > l; l++)
              (e = e.replace(new RegExp(`</${s[l]}>`, "gi"), `###/${s[l]}###`)),
                (e =
                  s[l] === "td" || s[l] === "th"
                    ? e.replace(
                        new RegExp(
          ...
          reconvertTags(t, e) {
            ...
            for (var r = i.length, s = 0; r > s; s++)
              t = t.replace(new RegExp(`###/${i[s]}###`, "gi"), `</${i[s]}>`);
            for (var s = 0; r > s; s++)
              t = t.replace(new RegExp(`###${i[s]}###`, "gi"), `<${i[s]}>`);
            for (var s = 0; r > s; s++)
              ...
              : (t.each(
                  ...
                  t.proxy(function(t, i) {
                    ...
                    i.match(/<pre(.*?)>(([\n\r\s]+)?)<code(.*?)>/i)
                      ...
                      (o = o.replace(/\$/g, "&#36;")),
                      (e = a
                        ? e.replace(i, `<pre${r}><code${s}>${o}</code></pre>`)
              ...
              : (t.each(
                  ...
                  t.proxy(function(t, i) {
                    ...
                    (o[2] = o[2].replace(/&nbsp;/g, " ")),
                      ...
                      (o[2] = o[2].replace(/\$/g, "&#36;")),
                      (e = e.replace(i, `<code${o[1]}>${o[2]}</code>`));
                  }, this),
                ),
                e);
          },
      ...
      dropdown() {
        return {
          ...
          buildItem(e, i) {
            ...
            const r = t(
              `<a href="#" class="redactor-dropdown-${e}" role="button" />`,
            );
          ...
          showIsUnFixedToolbar() {
            this.dropdown.active
              .css({
                position: "absolute",
                left: `${this.dropdown.position.left}px`,
                top: `${this.dropdown.button.innerHeight() +
                  this.dropdown.position.top}px`,
              })
              .show(),
              this.dropdown.active.redactorAnimation(
        ...
        return {
          ...
          blur(e) {
            this.start ||
              this.rtePaste ||
              (t(e.target).closest(
                `#${this.core.id()}, .redactor-toolbar, .redactor-dropdown, #redactor-modal-box`,
              ).length === 0 &&
                (!this.events.blured &&
        ...
        return {
          ...
          update() {
            ...
            if (r !== "") {
              ...
              if (i.length === 0) {
                const c = t(
                  `<a href="${r}" id="redactor-img-tmp">${this.utils.getOuterHtml(
                    e,
                  )}</a>`,
                );
          ...
          setFloating(e) {
            ...
            switch (r) {
              case "left":
                (s = "left"),
                  (a = `0 ${this.opts.imageFloatMargin} ${this.opts.imageFloatMargin} 0`);
                break;
              case "right":
                (s = "right"),
                  (a = `0 0 ${this.opts.imageFloatMargin} ${this.opts.imageFloatMargin}`);
                break;
              case "center":
      ...
      linkify() {
        return {
          ...
          convertVideoLinks(t) {
            const e = `<div class="${this.opts.videoContainerClass} redactor-linkify-object"><iframe class="redactor-linkify-object" width="500" height="281" src="`;
          ...
          convertLinks(e) {
            ...
            for (let o = i.length, r = 0; o > r; r++) {
              ...
              e = e.replace(
                ...
                `<a href="${a}${t.trim(
                  s,
                )}" class="redactor-linkify-object">${t.trim(n)}</a>`,
              );
            }
            return e;
          },
          ...
          templates() {
            (this.opts.modal = {
              "image-edit": `${String()}<div class="redactor-modal-tab redactor-group" data-title="General"><div id="redactor-image-preview" class="redactor-modal-tab-side"></div><div class="redactor-modal-tab-area"><section><label>${this.lang.get(
                "title",
              )}</label><input type="text" id="redactor-image-title" /></section><section><label>${this.lang.get(
                "caption",
              )}</label><input type="text" id="redactor-image-caption" aria-label="${this.lang.get(
                "caption",
              )}" /></section><section><label>${this.lang.get(
                "link",
              )}</label><input type="text" id="redactor-image-link" aria-label="${this.lang.get(
                "link",
              )}" /></section><section><label class="redactor-image-position-option">${this.lang.get(
                "image-position",
              )}</label><select class="redactor-image-position-option" id="redactor-image-align" aria-label="${this.lang.get(
                "image-position",
              )}"><option value="none">${this.lang.get(
                "none",
              )}</option><option value="left">${this.lang.get(
                "left",
              )}</option><option value="center">${this.lang.get(
                "center",
              )}</option><option value="right">${this.lang.get(
                "right",
              )}</option></select></section><section><label class="checkbox"><input type="checkbox" id="redactor-image-link-blank" aria-label="${this.lang.get(
                "link-in-new-tab",
              )}"> ${this.lang.get(
                "link-in-new-tab",
              )}</label></section><section><button id="redactor-modal-button-action">${this.lang.get(
                "insert",
              )}</button><button id="redactor-modal-button-cancel">${this.lang.get(
                "cancel",
              )}</button><button id="redactor-modal-button-delete" class="redactor-modal-button-offset">${this.lang.get(
                "delete",
              ...
              file: `${String()}<div class="redactor-modal-tab" data-title="Upload"><section><label>${this.lang.get(
                "filename",
              )} <span class="desc">(${this.lang.get(
                "optional",
              )})</span></label><input type="text" id="redactor-filename" aria-label="${this.lang.get(
                "filename",
              ...
              link: `${String()}<div class="redactor-modal-tab" data-title="General"><section><label>URL</label><input type="url" id="redactor-link-url" aria-label="URL" /></section><section><label>${this.lang.get(
                "text",
              )}</label><input type="text" id="redactor-link-url-text" aria-label="${this.lang.get(
                "text",
              )}" /></section><section><label class="checkbox"><input type="checkbox" id="redactor-link-blank"> ${this.lang.get(
                "link-in-new-tab",
              )}</label></section><section><button id="redactor-modal-button-action">${this.lang.get(
                "insert",
              )}</button><button id="redactor-modal-button-cancel">${this.lang.get(
        ...
        return {
          ...
          buildPosition() {
            ...
            e.addClass("redactor-placeholder-style-tag"),
              e.html(
                `#${this.core.id()}.redactor-placeholder::after ${this.placeholder.getPosition()}`,
              ),
              t("head").append(e);
          },
          getPosition() {
            return `{ top: ${this.core
              .editor()
              .css("padding-top")}; left: ${this.core
              .editor()
              .css("padding-left")}; }`;
          },
          isEditorEmpty() {
        ...
        return {
          ...
          rgb2hex(t) {
            return (
              ...
              t && t.length === 4
                ? `#${`0${parseInt(t[1], 10).toString(16)}`.slice(
                    -2,
                  )}${`0${parseInt(t[2], 10).toString(16)}`.slice(
                    -2,
