        ...
        swal(
          {
            ...
            confirmButtonClass:
              "confirm-class btn btn-primary btn-primary-important btn-rounded btn-sm",
            cancelButtonClass:
              "cancel-class btn btn-danger-important btn-rounded btn-sm",
          ...
          function(isConfirm) {
            if (isConfirm) {
              ...
              setTimeout(function() {
                swal(
                  "Approved!",
                  "You have successfully approved a service.",
                  "success",
                );
              }, 2000);
            } else {
              swal(
                "Opps..",
                "Remember to approve the service as soon as you can!",
                "error",
              );
            }
          },
        ...
        swal(
          {
            ...
            confirmButtonClass:
              "confirm-class btn btn-primary btn-primary-important btn-rounded btn-sm",
            cancelButtonClass:
              "cancel-class btn btn-danger btn-danger-important btn-danger-important btn-rounded btn-sm",
            closeOnConfirm: false,
            closeOnCancel: false,
          },
          function(isConfirm) {
            if (isConfirm) {
              ...
              setTimeout(function() {
                swal(
                  ...
                  "You have successfully paid a service.",
                  "success",
                );
              }, 2000);
            } else {
              swal(
                "Opps..",
                "Remember to pay for the service as soon as you can!",
                "error",
              );
            }
          },
        ...
        swal(
          {
            title: service,
            html:
              "This service will be <strong>stopped</strong> immediately once you confirm.",
            ...
            confirmButtonClass:
              "confirm-class btn btn-primary btn-primary-important btn-outline btn-rounded btn-sm",
            cancelButtonClass:
              "cancel-class btn btn-danger btn-outline btn-rounded btn-sm",
            closeOnConfirm: false,
            closeOnCancel: false,
          },
          function(isConfirm) {
            if (isConfirm) {
              ...
              setTimeout(function() {
                swal(
                  "Stopped!",
                  "Your stop service request is sent!",
                  "success",
                );
              }, 2000);
            } else {
        ...
        swal(
          {
            ...
            confirmButtonClass:
              "confirm-class btn btn-primary btn-primary-important btn-outline btn-rounded btn-sm",
            cancelButtonClass:
              "cancel-class btn btn-danger btn-danger-important btn-outline btn-rounded btn-sm",
            closeOnConfirm: false,
            closeOnCancel: false,
          },
          function(isConfirm) {
            if (isConfirm) {
              ...
              setTimeout(function() {
                swal(
                  "Denied!",
                  "Your deny service request is sent!",
                  "success",
                );
              }, 2000);
            } else {
