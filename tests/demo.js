...
const demo_service_template = [
  ...
  },
  {
    ...
    name: "Large Website",
    description:
      "Development of custom small CMS managed website (less than 50 pages)",
    details:
  ...
  },
  {
    ...
    details:
      "This includes x number of iterations and x number of sessions. Satisfaction guaranteed",
    published: true,
    category_id: 3,
    statement_descriptor: "Vampeo Web",
    trial_period_days: 0,
  ...
  },
  {
    ...
    details:
      "<p>We host your website and promise uptime and x time before response</p>",
    published: true,
    statement_descriptor: "Vampeo Web",
    trial_period_days: 0,
    amount: 10000,
...
const demo_service_template_properties = [
  ...
  },
  {
    ...
    prop_values: ["Medical", "Construction", "Consulting", "Other"],
  },
  {
...
const demo_service_instance = [
  ...
  },
  {
    ...
    name: "Small Website Hosting",
    description:
      "Cloud hosting for small websites <hr> <p>We host your website and promise uptime and x time before response</p>",
  ...
  },
  {
    ...
    name: "Small Website",
    description:
      "Development of custom small CMS managed website (less than 10 pages) <hr> ",
