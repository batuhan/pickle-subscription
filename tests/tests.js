...
const initConfig = {stripe_public: "pk_test_Ax20edZBpZW9YEpHeZoQqaKA", stripe_secret:"sk_test_43eiOmKqQMwG3zjZp1PPERiH"}
...
test('GET all roles - /api/v1/roles', function (assert) {
    ...
    const sampleRoles = [ { id: 1, role_name: 'admin' }, { id: 2, role_name: 'staff' }, { id: 3, role_name: 'user' } ];
