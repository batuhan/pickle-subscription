...
class Buttons extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      buttonClass:
        `btn btn-default btn-rounded ${this.props.buttonClass}` ||
      ...
      if (this.state.btnType == "default") {
        if (!hover) {
          btnStyle.backgroundColor = _.get(
            options,
            "button_default_color.value",
            "#cccccc",
          );
          btnStyle.color = _.get(
            options,
            "button_default_text_color.value",
            "#000000",
          );
        } else {
          btnStyle.backgroundColor = _.get(
            options,
            "button_default_hover_color.value",
            "#dddddd",
          );
          btnStyle.color = _.get(
            options,
        ...
        if (!hover) {
          btnStyle.backgroundColor = _.get(
            options,
            "button_primary_color.value",
            "#2980b9",
          );
          btnStyle.color = _.get(
            options,
            "button_primary_text_color.value",
            "#ffffff",
          );
        } else {
          btnStyle.backgroundColor = _.get(
            options,
            "button_primary_hover_color.value",
            "#3498db",
          );
          btnStyle.color = _.get(
            options,
        ...
        if (!hover) {
          btnStyle.backgroundColor = _.get(
            options,
            "button_info_color.value",
            "#00BCD4",
          );
          btnStyle.color = _.get(
            options,
            "button_info_text_color.value",
            "#000000",
          );
        } else {
          btnStyle.backgroundColor = _.get(
            options,
            "button_info_hover_color.value",
            "#26C6DA",
          );
          btnStyle.color = _.get(
            options,
        ...
        if (!hover) {
          btnStyle.backgroundColor = _.get(
            options,
            "btn_danger_do_not_change_color.value",
            "#d32f2f",
          );
          btnStyle.color = _.get(
            options,
            "button_danger_do_not_change_color.value",
            "#ffffff",
          );
        } else {
          btnStyle.backgroundColor = _.get(
    ...
    return (
      ...
      >
        ...
        <button
          ...
          style={
            this.state.style ? _.merge(this.state.style, btnStyle) : btnStyle
          }
