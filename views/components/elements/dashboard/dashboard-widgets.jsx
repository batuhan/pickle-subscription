      ...
      <div>
        <div className="dashboard-widgets">
          <Widget
            data={{
              label: "ARR",
              value: this.state.data.salesStats.subscriptionStats.annual,
            }}
            postFix="/yr"
            type="price"
          />
          <Widget
            data={{
              label: "MRR",
              value: this.state.data.salesStats.subscriptionStats.month,
            }}
            postFix="/mo"
            type="price"
          />
          <Widget
            data={{
              ...
              value: this.state.data.salesStats.overall.remainingCharges,
            }}
            type="price"
            wcolor={unpaidwcolor}
          />
