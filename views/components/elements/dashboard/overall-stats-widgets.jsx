...
class OverallStatsWidgets extends React.Component {
  ...
  render() {
    ...
    saleStat.push({
      label: "Users who Purchased",
      value: analytics.salesStats.overall.customersWithOfferings,
    });
    saleStat.push({
      label: "Active Sales",
      value: analytics.salesStats.overall.activeSales,
    });
    saleStat.push({
      label: "Requested Sales",
      value: analytics.salesStats.overall.requested,
    });
    saleStat.push({
      label: "Waiting Cancellations",
      value: analytics.salesStats.overall.waitingCancellation,
    });
    saleStat.push({
    ...
    subStat.push({
      ...
      value: analytics.salesStats.subscriptionStats.annual,
      type: "price",
    });
    subStat.push({
      label: "Monthly Recurring Revenue",
      value: analytics.salesStats.subscriptionStats.month,
      type: "price",
    });
    subStat.push({
      label: "Total Additional Charges",
      value: analytics.salesStats.subscriptionStats.totalCharges,
      type: "price",
    });
    subStat.push({
      label: "Paid Additional Charges",
      value: analytics.salesStats.subscriptionStats.totaPaidCharges,
      type: "price",
    });
    subStat.push({
      label: "Unpaid Additional Charges",
    ...
    scheduledStat.push({
      ...
      value: analytics.salesStats.split.splitTotalAmt,
      type: "price",
    });
    scheduledStat.push({
      label: "Paid Schedules",
      value: analytics.salesStats.split.splotPaidAmt,
      type: "price",
    });
    scheduledStat.push({
    ...
    onetimeStat.push({
      label: "Total Charges",
      value: analytics.salesStats.oneTimeStats.allCharges,
      type: "price",
    });
    onetimeStat.push({
      label: "Approved Charges",
      value: analytics.salesStats.oneTimeStats.singleApprove,
      type: "price",
    });
    onetimeStat.push({
    ...
    quoteStat.push({
      label: "Total Charges",
      value: analytics.salesStats.quote.customTotalAmt,
      type: "price",
    });
    quoteStat.push({
      label: "Approved Charges",
      value: analytics.salesStats.quote.customTotalPaidAmt,
      type: "price",
    });
    quoteStat.push({
      label: "Waiting Approvals",
    ...
    if (
      parseInt(analytics.totalUnpublishedTemplates) !== 0 &&
      parseInt(analytics.totalPublishedTemplates) !== 0
    )
      hadOfferings = "Yes";
      ...
      <div>
        <div className="row m-0">
          <div className="dashboard-widgets">
            <div className="dashboard-widget">
              <Widget
                data={{ label: "Sales Stat", list: saleStat }}
            ...
            <div className="dashboard-widget">
              <Widget
                data={{ label: "System Status", list: systemStat }}
                bodyClass="full-height"
              />
            </div>
          </div>
        ...
        <div className="row m-0">
          <div className="dashboard-widgets">
            <div className="dashboard-widget">
              <Widget
                data={{ label: "Subscription Stat", list: subStat }}
                bodyClass="full-height"
                wcolor="purple"
              />
            </div>
            <div className="dashboard-widget">
              <Widget
                data={{
                  label: "Sales vs. Churn Rate",
                  component: ServiceOverTimeChart,
                }}
                bodyClass="full-height"
                wcolor="grey"
              />
        ...
        <div className="row m-0">
          <div className="dashboard-widgets">
            <div className="dashboard-widget">
              <Widget
                data={{ label: "Scheduled Payment Sales", list: scheduledStat }}
                bodyClass="full-height"
                wcolor="theme-clear"
              />
            </div>
            <div className="dashboard-widget">
              <Widget
                data={{ label: "One Time Charge Sales", list: onetimeStat }}
                bodyClass="full-height"
                wcolor="theme-clear"
              />
            </div>
            <div className="dashboard-widget">
              <Widget
                data={{ label: "Quote Stats", list: quoteStat }}
                bodyClass="full-height"
                wcolor="theme-clear"
              />
            </div>
