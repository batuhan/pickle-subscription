...
class ForgotPassword extends React.Component {
  ...
  handleReset(e) {
    ...
    if (!self.state.form.email) {
      ...
      Fetcher("/api/v1/auth/reset-password", "POST", self.state.form).then(
        function(result) {
          if (!result.error) {
            ...
            <Content>
              <div className="login-container">
                <form className="forgot-password">
                  <div
                    className={`sb-form-group ${!this.state.form.email &&
                      this.state.submitted &&
                      "has-error"}`}
                  >
                    <div className="content-title">
                      <h4>Forot password</h4>
                    </div>
                    <p>
                      Please enter your email address to reset your password.
                      You will receive an emil with password reset instructions.
                    </p>
                    <input
                  ...
                  <div className={`sb-form-group buttons-group __gap`}>
                    ...
                    <Link
                      ...
                      to={{ pathname: "/login", state: { fromLogin: true } }}
                    >
                      Back to Login
                    </Link>
                  </div>
