...
import { inputField, ServicebotBaseForm } from "servicebot-base-form";
    ...
    if (this.state.loading) {
      ...
      return (
        <div className="p-20">
          <p>
            <strong>
              User invited Successfully! The invitation link is listed below as
              well:
            </strong>
          </p>
          <div className="code green">
            {this.state.response.url || "something went wrong."}
          </div>
        </div>
      );
    } else {
