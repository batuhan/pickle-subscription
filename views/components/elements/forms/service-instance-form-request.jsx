...
class ServiceRequestForm extends React.Component {
  ...
  render() {
    ...
    try {
      newPrice = getPrice(
        formJSON.references.service_template_properties,
        handlers,
        formJSON.amount,
      );
    ...
    return (
      <div className="service-request-form-body">
        ...
        <form onSubmit={handleSubmit}>
          ...
          <button
            className="buttons btn-rounded btn-primary btn-bar submit-request"
            type="submit"
            value="submit"
          >
            {getRequestText()}
...
ServiceRequestForm = consume("widget")(
...
class ServiceInstanceForm extends React.Component {
  ...
  render() {
    ...
    if (
      ...
      !this.state.hasCard &&
      initialValues.trial_period_days <= 0
    ) {
    ...
    return (
      <div>
        {!this.state.hasCard &&
          ...
          ((this.state.servicePrice > 0 &&
            initialValues.trial_period_days <= 0) ||
            this.state.templateData.type === "split") && <CardSection />}
