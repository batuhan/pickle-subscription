        ...
        <div id="review-content">
          <div className="p-20">
            ...
            <div id="service-review-content" className="Review">
              {!reviewJSON ? (
                <p>Please fill out the form to create your service template.</p>
              ) : (
                <p>Please review your entered information before submitting.</p>
              )}

              <div className="review-content-prop-item p-b-20">
                <h4 className="review-content-prop-item-title">
                  Review Basic Info
                </h4>
                <div>
                  <span className="label">Name: </span>
                  <span className="value">
                    {reviewJSON && reviewJSON.name
                      ? reviewJSON.name
                      : "Required."}
                  </span>
                </div>
                <div>
                  ...
                  <span className="value">
                    {reviewJSON && reviewJSON.description
                      ? reviewJSON.description
                      : "Required."}
                  </span>
                </div>
                <div>
              ...
              <div className="review-content-prop-item p-b-20">
                ...
                <div>
                  ...
                  <span className="value">
                    {reviewJSON &&
                      (reviewJSON.statement_descriptor
                        ? reviewJSON.statement_descriptor
                        : "Optional")}
                  </span>
                </div>
                ...
                <div>
                  ...
                  <span className="value">
                    {reviewJSON &&
                      (reviewJSON.amount ? reviewJSON.amount : "Required")}
                  </span>
                </div>
                <div>
                  ...
                  <span className="value">
                    {reviewJSON &&
                      (reviewJSON.currency ? reviewJSON.currency : "Required")}
                  </span>
                </div>
                <div>
                  ...
                  <span className="value">
                    {reviewJSON &&
                      (reviewJSON.interval ? reviewJSON.interval : "Required")}
                  </span>
                </div>
                <div>
                ...
                <div>
                  ...
                  <span className="value">
                    {reviewJSON
                      ? !reviewJSON.subscription_prorate
                        ? "Not prorated"
                        : "Prorated"
                      : "Not prorated"}
                  </span>
              ...
              {templateProps &&
                Object.entries(templateProps).map(propEntry => {
                  ...
                  return (
                    <div
                      key={propEntry[0]}
                      className="review-content-prop-item p-b-20"
                    >
                      <h4 className="review-content-prop-item-title">
                        Custom Fields
                      </h4>
                      ...
                      <div>
                        ...
                        <span className="value">
                          {propItem.private ? "Yes" : "No"}
                        </span>
                      </div>
                      <div>
                        <span className="label">Prompt User? </span>
                        <span className="value">
                          {propItem.prompt_user ? "Yes" : "No"}
                        </span>
                      </div>
                      <div>
                        <span className="label">Required? </span>
                        <span className="value">
                          {propItem.required ? "Yes" : "No"}
                        </span>
                      </div>
                      <div>
                        <span className="label">Input Type: </span>
                        <span className="value">
                          {propItem.prop_input_type}
                        </span>
                      </div>
                      <div>
                        <span className="label">Options Values:</span>
                        <span className="value">
                          {propItem.prop_values
                            ? propItem.prop_values.map(value => {
                                return (
