          ...
          <div className="service-fields">
            <div className="sb-form-group">
              ...
              <Inputs
                ...
                type="price"
                name="amount"
                label="Service Subscription Amount"
                value={defaultData.subscription.amount}
                onChange={this.handleChange}
              />
              {/*<input className="_input-" type="number" name="amount" value={defaultData.subscription.amount} onChange={this.handleChange}/>*/}
            </div>
            <div className="sb-form-group">
              ...
              <div className="row">
                <input
                  ...
                  type="hidden"
                  name="type"
                  value={defaultData.subscription.type}
                />
                <div className="col-md-4">
                  <input
                    ...
                    type="number"
                    name="interval_count"
                    value={defaultData.subscription.interval_count}
                    onChange={this.handleChange}
                  />
                </div>
            ...
            {/*<select className="_input-" type="select" name="subscription_prorate" value={defaultData.subscription.subscription_prorate} onChange={this.handleChange}>*/}
          ...
          <div className="service-fields">
            <div className="sb-form-group">
              ...
              <input
                ...
                type="hidden"
                name="type"
                value={defaultData.one_time.type}
              />
              <Inputs
                key="one_time_amount"
                type="price"
                name="amount"
                label="One-Time Charge Amount"
                value={defaultData.one_time.amount}
                onChange={this.handleChange}
              />
              {/*<input className="_input-" type="number" name="amount2" value={defaultData.one_time.amount} onChange={this.handleChange}/>*/}
            </div>
            <div className="sb-form-group">
              <input
                disabled
                ...
                type="hidden"
                name="interval"
                value={defaultData.one_time.interval}
              />
            </div>
            <div className="sb-form-group">
              <input
                ...
                type="hidden"
                name="interval_count"
                value={defaultData.one_time.interval_count}
              />
            </div>
            <div className="sb-form-group">
              <input
                ...
                value={defaultData.one_time.subscription_prorate}
              />
            </div>
          </div>
        );
        ...
        return (
          <div className="service-fields">
            <p className="help-block">
              You will be able to add custom service charges after an instance
              of this service as been created for a customer.
            </p>
            <div className="sb-form-group">
              <input
                className="_input-"
              ...
              <input
                ...
                type="hidden"
                name="amount"
                value={defaultData.custom.amount}
              />
            </div>
            <div className="sb-form-group">
              <input
                ...
                type="hidden"
                name="interval"
                value={defaultData.custom.interval}
              />
            </div>
            <div className="sb-form-group">
              <input
                ...
                type="hidden"
                name="subscription_prorate"
                value={defaultData.custom.subscription_prorate}
              />
            </div>
          </div>
        );
    ...
    return (
      <div>
        <div className="sb-form-group">
          ...
          <select
            disabled={this.props.formAction == "_EDIT"}
            className="_input-"
            type="select"
            name="service_type"
            value={this.state.serviceType}
            onChange={this.onToggleSubscription}
          >
