      ...
      <ul className="split-payment-items">
        {fields.map((member, index) => (
          <li className="split-payment-item" key={index}>
            <button
              className="buttons btn-rounded custom-field-button iconToggleField"
    ...
    return {
      ...
      clearConfig: () => {
        dispatch(
          change(
            TEMPLATE_FORM_NAME,
            `references.${ownProps.member}.config`,
            {},
          ),
        );
      },
      ...
      clearValue: () => {
        dispatch(
          change(
            TEMPLATE_FORM_NAME,
            `references.${ownProps.member}.data`,
            null,
          ),
        );
      },
      ...
      <div>
        <ul className="custom-fields-list">
          ...
          <li className="custom-field-item">
            <div className="sb-form-groupform-group-flex">
              <input
                className="form-control custom-property-add-field-toggle"
                autoFocus={false}
        ...
        <div className="row">
          <div className="col-md-8">
              ...
              {!options.stripe_publishable_key && (
                <Link to="/stripe-settings">
                  ...
                  <h4 className="form-error">
                    Publishing Disabled Until Setup Complete - Click here to
                    complete
                  </h4>
                </Link>
              )}
            ...
            <Field
              ...
              label="Category"
              options={formJSON ? formJSON._categories : []}
              validate={[required()]}
            />
          </div>
          <div className="col-md-4">
            <div style={sectionDescriptionStyle}>
              <SVGIcons
                ...
                fillColor={_.get(
                  options,
                  "service_template_icon_fill_color.value",
                  "#ffffff",
                )}
              >
                ...
                <path d="m128 112c-17.648 0-32 14.352-32 32s14.352 32 32 32 32-14.352 32-32-14.352-32-32-32zm0 48c-8.824 0-16-7.176-16-16s7.176-16 16-16 16 7.176 16 16-7.176 16-16 16z" />
                <path d="m128 200c-17.648 0-32 14.352-32 32s14.352 32 32 32 32-14.352 32-32-14.352-32-32-32zm0 48c-8.824 0-16-7.176-16-16s7.176-16 16-16 16 7.176 16 16-7.176 16-16 16z" />
                <path d="m128 288c-17.648 0-32 14.352-32 32s14.352 32 32 32 32-14.352 32-32-14.352-32-32-32zm0 48c-8.824 0-16-7.176-16-16s7.176-16 16-16 16 7.176 16 16-7.176 16-16 16z" />
                <path d="m128 376c-17.648 0-32 14.352-32 32s14.352 32 32 32 32-14.352 32-32-14.352-32-32-32zm0 48c-8.824 0-16-7.176-16-16s7.176-16 16-16 16 7.176 16 16-7.176 16-16 16z" />
            ...
            <p className="help-block">
              Enter the basic information about your service. Summary will be
              shown to users in the product / service listing pages, such as the
              home page featured items. Details will be shown on each individual
            ...
            <div className="row">
              ...
              <div className="col-md-4">
                ...
                <p className="help-block">
                  ...
                  charged. For example, you can setup a recurring charge for
                  your product / service by setting Billing Type to Subscription
                  and define how often your customer will get charged
                  automatically.
                </p>
              </div>
            </div>
            ...
            <div className="row">
              <div className="col-md-8">
                ...
                <div id="service-submission-box" className="button-box right">
                  <Link
                    className="buttons btn-rounded btn-default"
              ...
              <div className="col-md-4">
                ...
                <p className="help-block">
                  Define custom fields. You can collect additional information
                  from your customers by defining custom fields. Each custom
                  field can also be used as "Add-Ons" to your product /
                  services. For example, if you define a custom field for number
                  of rooms to be cleaned, you can set an additional cost that
                  will be charged toward your customer when they select the
