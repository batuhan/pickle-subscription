...
class SystemSettingsForm extends React.Component {
  ...
  handleConfirm() {
    ...
    Fetcher(self.state.stripe_configure, "POST", fData).then(function(
      response,
    ) {
      if (!response.error) {
        ...
        <React.Fragment>
            ...
            {settings.secret_key !== "" ? (
              <React.Fragment>
                ...
                <p className={`form-help-text`}>
                  You can modify your Stripe keys to go from test to live,
                  update to newer keys, or change to a different account.
                  Retrieve your keys{" "}
                  <a
                  ...
                  . If you are changing from test to live or entering keys to a
                  different account, you can choose to migrate data to a new
                  Stripe account, or clear Servicebot data and start fresh.
                </p>
              </React.Fragment>
            ) : (
              <React.Fragment>
                ...
                >
                  ...
                  {self.state.stripe_settings.secret_key && (
                    <Inputs
                      ...
                      options={[
                        {
                          "Reset Servicebot data and connect to the new Stripe account": true,
                        },
                        {
                          "Keep Servicebot data and import data to the new Stripe account": false,
                        },
                      ]}
                      onChange={function() {}}
                      receiveOnChange={true}
          ...
          {!self.props.initialize && (
            <div className={`_section`}>
              ...
              <p className={`form-help-text`}>
                Copy your Servicebot webhook URL below and paste it as a new{" "}
                <a
                  className="intext-link"
