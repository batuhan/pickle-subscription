      ...
      return (
        <div className="alert alert-success" role="alert">
          ...
          <Authorizer permissions="can_administrate">
            <Link
              to="/manage-users"
              className="btn btn-success btn-outline btn-rounded btn-sm pull-right"
            >
          ...
          <div className="p-20">
            ...
            <div className="row">
              <div className="basic-info col-md-6 col-md-offset-3">
                <div className="profile-header">
                  <div>
                    <h3 className="p-b-20">{user.email}</h3>
                  </div>
                  <div>
                    <small>
                      Last Login:{" "}
