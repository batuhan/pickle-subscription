...
class ServiceListItem extends React.Component {
  ...
  render() {
    ...
    if (this.state.image) {
      ...
      if (options) {
        style.header.backgroundColor = _.get(
          options,
          "service_box_header_background_color.value",
          "#000000",
        );
        style.header.color = _.get(
          options,
          "service_box_header_text_color.value",
          "#ffffff",
        );
      }
    } else {
    ...
    if (options) {
      style.body = {
        backgroundColor: _.get(
          options,
          "service_box_body_background_color.value",
          "#000000",
        ),
    ...
    let getRequestText = () => {
      ...
      if (
        ...
        if (
          _.get(this.props.options, "service_box_request_button_text.value") ===
          "default"
        ) {
    ...
    return (
      <div
        ...
        className="service-column col-xs-12 col-sm-6 col-lg-4 col-xl-4"
      >
        <div
          className="card-wrapper service"
          onClick={() => {
        ...
        >
          ...
          >
            ...
            >
              {this.state.icon &&
                _.get(this.props.options, "service_box_icon_display.value") ==
                  "true" && <img src={this.state.icon} alt="icon" />}
            ...
            <div className="card-block-wrapper">
              <div
                className={`card-block ${this.state.display_setting.icon &&
                  "with-icon"}`}
                style={style.body}
              >
