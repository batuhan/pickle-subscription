      ...
      <div className="featured-area">
        ...
        <div id="middle-column" className="col-xs-10 col-sm-8 col-md-6">
          ...
          <form id="search-service-form" className="search">
            ...
            <div
              id="search-service"
              className="form-group flat-input flat-rounded flat-full flat-lg flat-bolder"
            >
              <input
            ...
            <div
              id="search-category"
              className="form-group flat-input flat-rounded flat-lg flat-bolder float-right caret-right"
            >
