        ...
        <div id="middle-column" className="col-xs-10 col-sm-8 col-md-6">
          ...
          <form id="search-service-form" className="search">
            {(this.props.searchValue == "" ||
              ...
              <label
                id="search-service-label"
                className="flat-input flat-lg flat-bolder"
              >
                Search For Services
              </label>
            )}
            <div
              id="search-service"
              className="sb-form-groupflat-input flat-rounded flat-full flat-lg flat-bolder"
            >
              <input
            ...
            <div
              id="search-category"
              className="sb-form-groupflat-input flat-rounded flat-lg flat-bolder float-right caret-right"
            >
