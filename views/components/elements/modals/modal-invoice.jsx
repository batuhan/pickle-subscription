        ...
        let items = () => {
          return lineItems.map(item => (
            <tr key={item.id}>
              ...
              <td>
                <Price value={item.amount} currency={myNextInvoice.currency} />
              </td>
            </tr>
          ));
        };
              ...
              <div className="__invoice-information">
                <div className="__amount">
                  ...
                  <span>
                    ...
                    <Price
                      value={amountDue}
                      currency={myNextInvoice.currency}
                    />
                  </span>
                  <br />
                </div>
              ...
              <table className="table __invoice-table">
                ...
                <tfoot className="__invoice-footer">
                  <tr>
                    ...
                    <td>Total:</td>
                    <td>
                      <Price value={total} currency={myNextInvoice.currency} />
                    </td>
                  </tr>
                </tfoot>
              </table>
        ...
        return (
          ...
          >
            <div className="invoice-modal">
              <div className="__invoice-information">
                <p className="__no-invoice">
                  You do not have any invoice at the moment.
                </p>
              </div>
            </div>
          </Modal>
