...
class ModalPayAllCharges extends React.Component {
  ...
  onPay(event) {
    ...
    if (!self.state.hasCard) {
      ...
      Fetcher(self.state.pay_all_charges_url, "POST", {}).then(function(
        response,
      ) {
        if (!response.error) {
        ...
        >
          <div className="table-responsive">
            <div className="p-20">
              <div className="row">
                <div className="col-xs-12">
                  <p>
                    <strong>
                      You are about to pay the outstanding charges for your
                      item:
                    </strong>
                  </p>
                  ...
                  <p>
                    <strong>
                      Total Charges: <Price value={totalCharges} />
                    </strong>
                  </p>
                </div>
              </div>
            ...
            <div className={`modal-footer text-right p-b-20`}>
              ...
              <button
                className="buttons btn-primary btn-rounded"
                onClick={self.onPay}
              >
            ...
            <div className="p-20">
              <div className="row">
                <div className="col-xs-12">
                  <p>
                    <strong>
                      Thank you! You have paid <Price value={totalCharges} />.
                    </strong>
                  </p>
                  <p>
                    This charge will appear in your billing history shortly.
                  </p>
                </div>
              </div>
            </div>
