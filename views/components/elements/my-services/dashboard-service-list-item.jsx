      ...
      if (self.state.approveModal) {
        ...
        return (
          <ModalPayAllCharges
            ...
            show={self.state.payChargeModal}
    ...
    if (self.props.service && self.props.service != null) {
          ...
          return (
            <div>
              {serType == "subscription" && (
                <div className="xaas-price red">{getSubscriptionPrice()}</div>
              )}
              {getTotalCharges() && (
                <div className="xaas-price red m-l-5">{getTotalCharges()}</div>
              )}
            </div>
          );
        } else {
      ...
      let getActionButton = () => {
        if (
          ...
          return (
            <button
              className="buttons btn-default btn-rounded btn-sm"
      ...
      let getTrialActionButton = () => {
        if (self.props.userFunds) {
          return (
            <TrialActionButton
              userFunds={self.props.userFunds}
              serviceInstance={myService}
        ...
        <div className={`xaas-row ${self.props.service.status}`}>
          <Link to={self.props.viewPath}>
            <div className="xaas-title">
              <div className="xaas-data xaas-status">
                <span className="status">
                  <i className={myService.icon} />
                </span>
              </div>
