    ...
    services.forEach(service => {
      ...
      if (
        (service.status !== "waiting_cancellation" &&
          ...
          service.outstanding_charges) ||
        (service.status === "requested" && service.payment_plan.amount > 0)
      ) {
        purchasedItems.actionItems.push(service);
        service.icon = "fa fa-flag";
      } else if (
        service.status === "requested" &&
        service.payment_plan.amount === 0
      ) {
    ...
    return (
      <div>
        {purchasedItems.actionItems.length > 0 && (
          <Collapsible
            triggerWhenOpen={this.getTrigger(
              "fa-chevron-down",
              "Items Waiting for Payment Approval",
            )}
          ...
          >
            <div className="service-instance-box-content">
              <p>
                These services need your attention, please approve the item or
                pay the charges as soon as possible.
              </p>
        ...
        {purchasedItems.trialItems.length > 0 && (
          ...
          >
            <div className="service-instance-box-content">
              <p>
                These services are currently in trial. If the fund is not added
                prior to the trial expiration, the service will be automatically
                cancelled.
              </p>
        ...
        {purchasedItems.quoteItems.length > 0 && (
          ...
          >
            <div className="service-instance-box-content">
              <p>
                These services are waiting to be scoped out. Make sure to add
                the necessary details so we can provide you with the most
                accurate quote.
              </p>
        ...
        {purchasedItems.pendingItems.length > 0 && (
          ...
          >
            <div className="service-instance-box-content">
              <p>
                Following items are pending cancellation by the store staff.
              </p>
        ...
        {purchasedItems.archivedItems.length > 0 && (
          <Collapsible
            triggerWhenOpen={this.getTrigger(
              "fa-chevron-down",
              "Cancelled and Completed Items",
            )}
            trigger={this.getTrigger(
              "fa-chevron-right",
              "View Cancelled and Completed Items",
            )}
            openedClassName="black"
            className="black"
          >
            <div className="service-instance-box-content">
