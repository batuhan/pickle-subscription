...
class ServiceInstanceApprovedCharges extends React.Component {
  ...
  getStatus(approved = false) {
    if (approved) {
      return <span className="tag tag-info tag-md">Paid</span>;
    }
    return <span className="tag tag-warning tag-md">Pending</span>;
  }
  ...
  getChargeHistory() {
    ...
    if (approveItems.length > 0) {
      ...
      return (
        <Collapsible
          trigger="Approved Charges - Previous Billing Cycles"
          openedClassName="opened"
        >
          <div className="service-instance-box-content">
            <p>
              The following charges are approved during previous billing cycles.
              The base subscription price is not included. This list only
              includes the approved additional charges.
            </p>
            <Datatable
              dataObj={approveItems}
            ...
            <div className="xaas-body-row additional-charges-total dark">
              <div className="xaas-data xaas-charge">
                <span>
                  <strong>
                    Total Approved:{" "}
                    <Price currency={currency} value={totalCharges} />
                  </strong>
                </span>
              </div>
            </div>
    ...
    if (approveItems.length > 0) {
      ...
      return (
        <div className="service-instance-actions">
          ...
          <div className="service-instance-box-content">
            <p>
              Following charges are one time charges that have been approved for
