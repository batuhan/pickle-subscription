      ...
      <div className="">
        <div className="service-instance-box">
          ...
          <div
            ...
            className="service-instance-box-content"
            style={this.getToggleStyle()}
            dangerouslySetInnerHTML={this.createMarkup(
              this.props.instanceDescription,
            )}
          />
          {this.state.descriptionHeight > 315 && (
            <div className="instance-details-toggle">
              <span
                ...
                className="buttons btn-info btn-outline btn-rounded btn-sm"
              >
                {!this.state.opened ? "Show More" : "Show Less"}
              </span>
            </div>
          )}
        </div>
