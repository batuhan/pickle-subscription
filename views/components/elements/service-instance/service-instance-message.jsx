                    ...
                    return (
                      <li key={message.id} className="comment">
                        ...
                        <div className="media-body">
                          <h4 className="media-heading text-capitalize">
                            <small>{message.references.users[0].name}</small>
                          </h4>
                          <h4 className="message-date">
                            <small>
                              <DateFormat time date={message.created_at} />
                            </small>
                          </h4>
