        ...
        <ul className="nav navbar-nav">
          ...
          <li className="dropdown">
            ...
            <ul className="dropdown-menu">
              <li>
                <Link to="/manage-catalog/list">Manage Offerings</Link>
              </li>
              <li>
          ...
          <li className="dropdown">
            ...
            <ul className="dropdown-menu">
              <li>
                <Link to="/stripe-settings">Stripe Settings</Link>
              </li>
              <li>
                <Link to="/notification-templates">Email Settings</Link>
              </li>
              <li>
                <Link to="/manage-permission">Permission Settings</Link>
              </li>
              <li>
      ...
      return (
        ...
        >
          <Link to="/stripe-settings">
            <ReactTooltip
              id="notification-stripe-keys"
              className="notification-stripe-keys"
              aria-haspopup="true"
              role="example"
              place="bottom"
              type="error"
            ...
            >
              <p>
                <strong>
                  You need to complete your setup to unlock certain features:
                </strong>
              </p>
              <ul>
                <li>User Invites</li>
      ...
      <div>
        {!embed && (
          <div>
                ...
                <div className="collapse navbar-collapse">
                  ...
                  <Authorizer>
                    <ul className="nav navbar-nav navbar-right">
                      ...
                      <li>
                        <button
                          className="buttons btn-link btn-signout"
            ...
            <SideNav
              sidebarLogout={this.props.handleLogout}
...
export default consume("routeDefinition")(
  connect(mapStateToProps)(NavBootstrap),
);
