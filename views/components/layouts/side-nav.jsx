...
class SlideNavLinks extends React.Component {
        ...
        },
        {
          ...
          links: [
            ...
            },
            {
              ...
              url: `/billing-settings/${props.uid}`,
              permission: ["authorized"],
  ...
  getLinksByPermission() {
    ...
    if (
      this.props.user &&
      isAuthorized({ permissions: ["can_administrate", "can_manage"] })
    ) {
      permission = ["can_administrate, can_manage"];
                    ...
                    {link.links.map((groupLink, index) => (
                      <li key={`group-link-${index}`}>
                        ...
                        >
                          ...
                          <i className="material-icons pull-left icon">
                            {groupLink.icon}
                          </i>
                        </Link>
                      </li>
  ...
  render() {
    ...
    if (this.props.options) {
      if (this.props.options.primary_theme_background_color) {
        style = {
          ...style,
          backgroundColor: this.props.options.primary_theme_background_color
            .value,
        };
              ...
              <div className="sidebar-heading" style={style}>
                ...
                <div className="sidebar-options">
                  <div className="dropdown">
                    <Link
                      className="buttons btn-primary btn-raised dropdown-toggle"
