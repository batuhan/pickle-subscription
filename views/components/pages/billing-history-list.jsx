...
class BillingHistoryList extends React.Component {
  ...
  modInvoiceId(data, resObj) {
    return (
      <Link to={`/billing-history/invoice/${resObj.id}`}>
        {resObj.invoice_id}
      </Link>
    );
  }
  ...
  onViewInstance(dataObject) {
    return function(e) {
      ...
      if (dataObject != null) {
        browserHistory.push(
          `/service-instance/${dataObject.service_instance_id}`,
        );
      }
    };
  }
      ...
      if (self.state.refundModal) {
        return (
          <ModalRefund
            ...
            show={self.state.refundModal}
            hide={self.closeRefundModal}
          />
        );
      }
    };
              ...
              buttons: [
                {
                  ...
                  name: "View Invoice",
                  link: "#",
                  onClick: this.onViewInvoice,
                },
                {
                  id: 2,
                  name: "View Service Page",
                  link: "#",
                  onClick: this.onViewInstance,
                },
                {
                  id: 3,
                  name: "divider",
