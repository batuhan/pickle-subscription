...
class CustomerInvoice extends React.Component {
              ...
              {refunds.map((refund, index) => (
                <p key={"refund-" + index} className="_item">
                  ...
                  <span className={`_value_wrap`}>
                    <span className={`_value`}>{refund.reason}</span>
                  </span>
                  <span className={`_value_wrap`}>
                    <span className={`_value`}>{refund.status}</span>
                  </span>
                </p>
              ))}
            </div>
  ...
  render() {
    ...
    return (
      <div
        className={`servicebot-invoice-modal-container`}
        ...
        <div className={`__modal`}>
          ...
          <div className={`__body`}>
            ...
            <div className={`mbf-summary`}>
              ...
              <p className={`_total`}>
                ...
                <span className={`_value`}>
                  <Price value={invoice.total} currency={invoice.currency} />
                </span>
              </p>
            </div>
          ...
          <div className={`__footer`}>
            <div className={`buttons-group __gap`}>
              <ReactToPrint
                ...
                trigger={() => (
                  <button
                    ...
                    className={`buttons _primary _download-invoice`}
                  >
                    Print Invoice
                  </button>
                )}
              ...
              />
              <button
                className={`buttons _primary _red _refund-invoice`}
                onClick={() => {
                  self.props.refund(invoice);
                }}
              >
                Refund
              </button>
