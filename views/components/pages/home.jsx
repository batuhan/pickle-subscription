...
class Home extends React.Component {
  constructor(props) {
    ...
    this.state = {
      serviceUrl:
        "/api/v1/service-templates/public?order_by=created_at&limit=6&order=desc",
      searchValue: "",
      editingMode: false,
      editingGear: false,
    };
  ...
  render() {
    ...
    if (this.props.options) {
      ...
      featuredServicesShowAllButton = _.get(
        options,
        "featured_service_show_all_button_text.value",
        "Show All Services",
      );
      featuredServiceSectionBackgroundColor = _.get(
        options,
        "featured_service_section_background_color.value",
        "Show All Services",
      );
    }
    ...
    return (
      <div className="page-home">
        ...
        <Content>
          <PageSection
            style={{ background: featuredServiceSectionBackgroundColor }}
          ...
          >
            <div>
              ...
              <Buttons
                ...
                onClick={() => {
                  browserHistory.push("/all-services");
                }}
              />
              {this.state.editingGear && (
                <AdminEditingGear
                  toggle={this.toggleEditingMode}
                  name="Featured Services Settings"
                />
              )}
...
class HomeFeatures extends React.Component {
  ...
  render() {
    ...
    featuredHeading = _.get(
      ...
      '"You can set this heading in system options',
    );
    featuredDescription = _.get(
      options,
      "home_featured_description.value",
    ...
    let featuredHeadingStyle = this.props.featuredHeadingStyle || {
      ...
      color: _.get(
        this.props.options,
        "home_featured_text_color.value",
        "#ffffff",
      ),
    };
