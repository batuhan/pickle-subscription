        ...
        <div className="mini-notification-list">
          {totalUnread ? (
            <li className="text-center">
              <strong>{`You have ${totalUnread} unread notifications`}</strong>
            </li>
          ) : (
            <span />
          )}
          <ul>
            ...
            <li className="text-center" onClick={this.viewAll}>
              View All
            </li>
          </ul>
        </div>
      ...
      <li className="nav-notification">
        <div>
          <span onClick={this.openNotificationDropdown}>
            <i
              className="fa fa-bell nav-notification-icon"
              aria-hidden="true"
            />
            {unread.length ? (
        ...
        {this.state.openNotificationDropdown && (
          <div
            className="mini-notification-backdrop"
          ...
          <Content>
            <div className="row m-b-20">
              <div className="col-xs-12">
                ...
                {isAuthorized({
                  permissions: "put_notification_templates_id",
                }) && (
                  <div>
                    <p>
