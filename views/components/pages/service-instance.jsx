        ...
        <Authorizer permissions="can_administrate">
          <div className="btn-group pull-right">
            ...
            <ul className="dropdown-menu dropdown-menu-right">
              <li>
                <Link to="#" onClick={self.handleEditInstanceModal}>
                  Edit Instance
                </Link>
              </li>
              <li>
                <Link to="#" onClick={self.handleEditPropertiesModal}>
                  Edit Properties
                </Link>
              </li>
              <li>
                <Link to="#" onClick={self.handleEditPaymentModal}>
                  Edit Payment Plan
                </Link>
              </li>
              {instance.payment_plan && instance.status !== "cancelled" && (
                <li>
                  <Link to="#" onClick={self.handleAddChargeItemModal}>
                    Add Charge
                  </Link>
                </li>
              )}
