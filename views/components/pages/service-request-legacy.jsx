  ...
  render() {
    ...
    return (
      <Featured
        ...
        style={featuredStyle}
        overlay={{ show: true, style: featuredOverlayStyle }}
      >
        <PageSection
          className="request-featured-section"
        ...
        >
          ...
          <div className="request-featured-section" style={featuredTextStyle}>
            <h1 className="featured-title" style={featuredTextStyle}>
              {name}
            </h1>
            <p className="featured-body" style={featuredTextStyle}>
              {description}
            </p>
            {trial_period_days > 0 ? (
...
RequestPageFeatured = connect(state => {
  return { options: state.options };
})(RequestPageFeatured);
ServiceRequest = connect(state => {
  return { options: state.options };
})(ServiceRequest);
