...
class SetupDB extends React.Component {
  ...
  render() {
    return (
      <div>
        <p>
          Enter your PostgreSQL database information. If you don't have access
          to a database, you can try the instant
          <a href="https://servicebot.io/pricing" target="_blank">
            {" "}
            ServiceBot cloud hosted solution
          </a>
          .
        </p>
        <div className="row">
          ...
          <input
            ...
            value={this.props.state.db_host}
        ...
        <div className="row">
          ...
          <input
            className="form-control"
            value={this.props.state.db_name}
            onChange={this.props.inputChange}
            name="db_name"
          />
        </div>
        <div className="row">
          ...
          <input
            className="form-control"
            value={this.props.state.db_user}
            onChange={this.props.inputChange}
            name="db_user"
          />
        </div>
        <div className="row">
          ...
          <input
            className="form-control"
            type="password"
            value={this.props.state.db_password}
            onChange={this.props.inputChange}
            name="db_password"
          />
        </div>
        <div className="row">
          ...
          <input
            className="form-control"
            value={this.props.state.db_port}
            onChange={this.props.inputChange}
            name="db_port"
            placeholder="5432"
          />
...
class SetupAdmin extends React.Component {
  ...
  render() {
    return (
      <div>
        <p>Enter your ServiceBot site configuration.</p>
        <div className="row">
          ...
          <input
            ...
            type="email"
            className="form-control"
            value={this.props.state.admin_user}
            onChange={this.props.inputChange}
            name="admin_user"
          />
        </div>
        ...
        <div className="row">
          ...
          <input
            ...
            className="form-control"
            type="password"
            value={this.props.state.admin_password}
            onChange={this.props.inputChange}
            name="admin_password"
          />
        </div>
        ...
        <div className="row">
          ...
          <input
            className="form-control"
            value={this.props.state.company_address}
            onChange={this.props.inputChange}
        ...
        <div className="row">
          ...
          <input
            type="tel"
            className="form-control"
            value={this.props.state.company_phone_number}
            onChange={this.props.inputChange}
        ...
        <div className="row">
          ...
          <input
            type="email"
            className="form-control"
            value={this.props.state.company_email}
            onChange={this.props.inputChange}
            name="company_email"
          />
        </div>
        <div className="row">
          ...
          <input
            className="form-control"
            value={this.props.state.hostname}
            onChange={this.props.inputChange}
            name="hostname"
          />
        </div>
      ...
      <div>
        ...
        <div className="row">
          ...
          <input
            required
            className="form-control"
            value={this.props.state.stripe_public}
            onChange={this.props.inputChange}
            name="stripe_public"
          />
        </div>
        <div className="row">
          ...
          <input
            required
            className="form-control"
            value={this.props.state.stripe_secret}
            onChange={this.props.inputChange}
            name="stripe_secret"
          />
        </div>
...
class Setup extends React.Component {
  ...
  handleSubmit(e = null) {
    ...
    Fetcher("/setup", "POST", self.state.form).then(function(result) {
      if (!result.error) {
