...
function Adjustment(props){
    ...
    const formatter = new Intl.NumberFormat("en-US", { style: 'currency', currency }).format;
    ...
    switch(operation) {
        case "add":
            message = (
              <div className="_price">
                <span className="_value">{formatter(Number(price))}</span> 
                {' '}
        ...
        case "multiply" :
            message = (
              <div className="_price">
                <span className="_value">{price}</span>
% 
                {' '}
