...
class WidgetPricingInput extends React.Component {
  ...
  render() {
    ...
    if (operation == "add" || operation == "subtract") {
      ...
      let prefix =
        formatParts[1].type === "literal"
          ? formatParts[0].value + formatParts[1].value
          : formatParts[0].value;

      return (
        <NumberFormat
          className="_input- addon-checkbox-widget-price-input"
          name={name}
          prefix={prefix}
          decimalSeparator="."
          thousandSeparator=","
          ...
          onValueChange={this.handleChange(true)}
          value={price}
        />
      );
      ...
      return (
        <NumberFormat
          ...
          suffix="%"
          allowNegative={false}
          onValueChange={this.handleChange(false)}
          value={value}
        />
