    ...
    return (
      <Router history={browserHistory}>
        <Route name="Home" path="/" component={App}>
          ...
          <Route
            name="My Account"
            path="my-services/service-instance/"
            component={MyServices}
          />
          <Route
            name="Service Instance"
            path="my-services/service-instance/:instanceId"
            component={ServiceInstance}
          />
          <Route
            name="Service Instance"
            path="service-instance/:instanceId"
            component={ServiceInstance}
          />
          <Route
          ...
          <Route
            ...
            path="service-catalog/:templateId/request"
          ...
          >
            ...
            <Route
              name="Manage Offerings"
              path="list"
              component={ManageCatalogList}
            />
            <Route
              name="Create Template"
              path="create"
              component={ManageCatalogCreate}
            />
            <Route
              name="Edit Template"
              path=":templateId"
              component={ManageCatalogEdit}
            />
            <Route
          ...
          <Route
            name="Services"
            path="manage-subscriptions/:status"
            component={ManageSubscriptions}
          />

          {/* Other */}
          <Route
            path="service-templates/lite"
            component={ServiceTemplateFormLite}
          />
          <Route
            name="Embeddables"
            path={"/embeddables"}
            component={Embeddables}
          >
          ...
          />
          {this.props.routeDefinition &&
            this.props.routeDefinition.reduce((acc, route, index) => {
              acc.push(
                <Route
                  key={index}
                  name={route.name}
...
AppRouter = connect(
  state => ({
    user: state.user,
    routeDefinition: state.pluginbot.services.routeDefinition,
  }),
  mapDispatch,
)(AppRouter);
